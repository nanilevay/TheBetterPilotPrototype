 ...
 * data.
 */
public class StringSerialController : MonoBehaviour
{
    ...
    //public static MySerialController instance;

    [SerializeField][HideInInspector]
    string[] ports;

    public string macPortPrefix = "tty";
    ...
    void UpdatePorts()
    {
        ...
        //Mac
         ...
         // Are we on Unix?
         if (p == 4 || p == 128 || p == 6) {
             string[] ttys = System.IO.Directory.GetFiles ("/dev/", macPortPrefix+".*");
             ...
             {
                 if (ttys[i].StartsWith ("/dev/"+macPortPrefix+"."))
                 {
                     string dev = ttys[i].Substring(("/dev/"+macPortPrefix+".").Length);
